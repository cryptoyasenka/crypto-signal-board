  ...
  return (
    <div className="flex items-center gap-1.5" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {open && (
          <div className="absolute right-0 top-full mt-1 z-50 w-56 bg-zinc-900 border border-zinc-700/50 rounded-xl shadow-xl shadow-black/40 overflow-hidden">
            {/* Search */}
